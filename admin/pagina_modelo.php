            ...
            <article>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card border-start-primary h-100 shadow-sm" style="border-left-color: #0d6efd;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Total de Produtos</p>
                                    <h3 class="fw-bold mb-1">1.248</h3>
                                    <small class="text-success fw-medium"><i class="bi bi-arrow-up-short"></i> +3.2%</small> <span class="text-muted small">vs. mês ant.</span>
                                </div>
                    ...
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card h-100 shadow-sm" style="border-left-color: #198754;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Itens em Estoque</p>
                                    <h3 class="fw-bold mb-1">8.590</h3>
                                    <small class="text-success fw-medium"><i class="bi bi-arrow-up-short"></i> +1.8%</small> <span class="text-muted small">vs. mês ant.</span>
                                </div>
                                <div class="bg-success-subtle text-success p-3 rounded-3 fs-3"><i class="bi bi-boxes"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card h-100 shadow-sm" style="border-left-color: #ffc107;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Estoque Baixo</p>
                                    <h3 class="fw-bold text-warning mb-1">37</h3>
                                    <small class="text-danger fw-medium"><i class="bi bi-arrow-up-short"></i> +12%</small> <span class="text-muted small">crítico</span>
                                </div>
                                <div class="bg-warning-subtle text-warning p-3 rounded-3 fs-3"><i class="bi bi-exclamation-triangle"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card h-100 shadow-sm" style="border-left-color: #dc3545;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Sem Estoque</p>
                                    <h3 class="fw-bold text-danger mb-1">12</h3>
                                    <small class="text-success fw-medium"><i class="bi bi-arrow-down-short"></i> -4%</small> <span class="text-muted small">recuperado</span>
                                </div>
                                <div class="bg-danger-subtle text-danger p-3 rounded-3 fs-3"><i class="bi bi-x-circle"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card h-100 shadow-sm" style="border-left-color: #0dcaf0;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Entradas (Mês)</p>
                                    <h3 class="fw-bold mb-1">452</h3>
                                    <small class="text-success fw-medium"><i class="bi bi-arrow-up-short"></i> +8.4%</small> <span class="text-muted small">vs. mês ant.</span>
                                </div>
                                <div class="bg-info-subtle text-info p-3 rounded-3 fs-3"><i class="bi bi-arrow-down-left-circle"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card h-100 shadow-sm" style="border-left-color: #fd7e14;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Saídas (Mês)</p>
                                    <h3 class="fw-bold mb-1">318</h3>
                                    <small class="text-success fw-medium"><i class="bi bi-arrow-up-short"></i> +14%</small> <span class="text-muted small">giro alto</span>
                                </div>
                                <div class="bg-warning-subtle text-orange p-3 rounded-3 fs-3" style="color: #fd7e14;"><i class="bi bi-arrow-up-right-circle"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card h-100 shadow-sm" style="border-left-color: #6f42c1;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Valor do Estoque</p>
                                    <h3 class="fw-bold mb-1">R$ 286.450</h3>
                                    <small class="text-success fw-medium"><i class="bi bi-arrow-up-short"></i> +5.1%</small> <span class="text-muted small">patrimônio</span>
                                </div>
                                <div class="bg-purple-subtle text-purple p-3 rounded-3 fs-3" style="color: #6f42c1; background-color: #f1e9ff;"><i class="bi bi-currency-dollar"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="card stat-card h-100 shadow-sm" style="border-left-color: #6c757d;">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-uppercase text-muted small fw-semibold mb-1">Fornecedores Ativos</p>
                                    <h3 class="fw-bold mb-1">84</h3>
                                    <small class="text-muted small">Estáveis no mês</small>
                                </div>
                                <div class="bg-secondary-subtle text-secondary p-3 rounded-3 fs-3"><i class="bi bi-truck"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-12 col-xl-8">
                        <div class="card border-0 shadow-sm p-3">
                            <div class="card-body">
                                <h5 class="card-title fw-bold mb-3">Movimentação de Estoque (Entradas x Saídas)</h5>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card border-0 shadow-sm p-3">
                            <div class="card-body">
                                <h5 class="card-title fw-bold mb-3">Distribuição por Categoria</h5>
                                <div style="position: relative; height:320px;">
