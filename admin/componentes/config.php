...
<?php define('SESSION_TTL', 60 * 60 * 5);
...
<?php function gerachave()
{
 ...
 <?php function gerachaveshorttag()
{
    $length = 5;
 ...
 <?php function somardias($data, $dias)
{
 ...
 <?php function diferencadedata($data, $hora)
{
 ...
 <?php function gerarChaveUnica($tamanho = 8)
{
