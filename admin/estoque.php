...
<?php require_once  'query/query_estoque.php' ?>
            ...
            <article>
                <div class="d-flex flex-column flex-xl-row justify-content-between align-items-start align-items-xl-center mb-4 gap-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 align-items-center">
                        ...
                        <a href="produto_editar.php" class="btn btn-primary d-flex align-items-center gap-2">
                            <i class="bi bi-plus-circle"></i> Novo Produto
                        </a>
                        <a href="estoque_entrada.php" class="btn btn-success d-flex align-items-center gap-2">
                            <i class="bi bi-box-arrow-in-down"></i> Registrar Entrada
                        </a>
                        <a href="estoque_saida.php" class="btn btn-danger d-flex align-items-center gap-2" >
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle mb-0 text-nowrap">
                                        ...
                                        <tbody>
                                            <?php foreach ($dados as $estoques) { ?>
                                                <tr>
                                                    <td class="ps-4 fw-medium text-muted"><?= $estoques['id']; ?></td>
                                                    <td><?= $estoques['produto_id'];  ?></td>
                                                    <td><span class="badge bg-success-subtle text-success border border-success-subtle px-2"><?= $estoques['tipo']; ?></span></td>
                                                    <td class="fw-bold text-success"><?= $estoques['quantidade']; ?></td>
                                                    <td class="text-wrap"><?= $estoques['observacao']; ?></td>
                                                    <td><small class="text-muted"><?= $estoques['criado_em'];  ?></small></td>
